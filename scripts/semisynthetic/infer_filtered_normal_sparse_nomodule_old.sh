...
export DATASET_DIR="${PROJECT_DIR}/datasets/semisynthetic_old"
...
inference_dir=${DATASET_DIR}/trial_${trial}/read_depth_${read_depth}/inference_filtered_normal_sparse_nomodule
