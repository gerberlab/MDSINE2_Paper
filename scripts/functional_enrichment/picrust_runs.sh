...
place_seqs.py -s ${SEQUENCES_DIR} -o "${PICRUST_OUTPUT_DIR}/places_seqs.tre" -p 1 --intermediate ${PICRUST_OUTPUT_DIR}/working
...
gunzip -c "${PICRUST_OUTPUT_DIR}/marker_nsti_predicted.tsv.gz" > "${PICRUST_OUTPUT_DIR}/marker_nsti_predicted.tsv"
...
gunzip -c "${PICRUST_OUTPUT_DIR}/EC_predicted.tsv.gz" > "${PICRUST_OUTPUT_DIR}/EC_predicted.tsv"
...
gunzip -c "${PICRUST_OUTPUT_DIR}/KO_predicted.tsv.gz" > "${PICRUST_OUTPUT_DIR}/KO_predicted.tsv"
