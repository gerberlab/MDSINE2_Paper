...
def parse_arguments():
    ...
    parser.add_argument("-f", "--study_file", required=True, type=str,
                        help="<Required> The location of the study object")
    parser.add_argument("-o", "--output_path", required=True, type=str,
                        help="<Required> Path to which the output should be saved to.")
    parser.add_argument("-n", "--n_bugs", required=True, type=int,
                        help="<Required> The top n most abundant bugs that are retained")
