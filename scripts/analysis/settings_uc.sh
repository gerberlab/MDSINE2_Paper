...
export MAIN_DSET=${DATASET_DIR}/preprocessed/gibson_uc_agg_filtered.pkl
...
export INTERACTION_IND_PRIOR="weak-agnostic"  # changed from strong-sparse, for runtime estimate
