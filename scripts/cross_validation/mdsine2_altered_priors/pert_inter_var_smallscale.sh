...
inference_out_dir=$OUTPUT_DIR/mdsine2-modules-inter-var-smallscale/${excluded_subj}
...
# interaction-str-var-scale 1e-10, using DOF of 2.01.
# pert-str-var-scale 1e-10, using DOF of 2.01.
python cross_validation/helpers/mdsine2_loo_pert_int.py \
		--input $DATASET_PKL \
		...
		--pert-str-var-scale 1e-10 \
		--pert-str-var-dof 2.01 \
