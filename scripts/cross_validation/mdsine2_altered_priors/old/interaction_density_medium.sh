...
inference_out_dir=$OUTPUT_DIR/mdsine2-modules-interaction-density-medium/${excluded_subj}
mkdir -p ${inference_out_dir}

echo "[*] Running cross-validation run for MDSINE2 with centered interaction-ind prior (Excluding subject: ${excluded_subj})"
