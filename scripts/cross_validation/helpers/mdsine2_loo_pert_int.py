...
def parse_args() -> argparse.Namespace:
    ...
    parser.add_argument(
        '--pert-str-var-scale', type=float, dest='pert_str_var_scale',
        required=False, help='The scale parameter for the perturbation strength prior var.', default=None
    )
    parser.add_argument(
        '--pert-str-var-dof', type=float, dest='pert_str_var_dof',
        required=False, help='The dof parameter for the perturbation strength prior var.', default=None
    )
    parser.add_argument(
...
def main():
    ...
    if args.pert_str_var_scale != None:
        # This overrides `gaussian_inflation_factor` for perturbation.
        params.INITIALIZATION_KWARGS[STRNAMES.PRIOR_VAR_PERT]['scale_option'] = 'manual'
        params.INITIALIZATION_KWARGS[STRNAMES.PRIOR_VAR_PERT]['scale'] = args.pert_str_var_scale

    if args.pert_str_var_dof != None:
        params.INITIALIZATION_KWARGS[STRNAMES.PRIOR_VAR_PERT]['dof_option'] = 'manual'
        params.INITIALIZATION_KWARGS[STRNAMES.PRIOR_VAR_PERT]['dof'] = args.pert_str_var_dof
