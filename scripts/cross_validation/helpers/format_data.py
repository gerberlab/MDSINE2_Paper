...
if __name__ == "__main__":
    ...
    print("Checker")
    print("len(Y):{}, len(U):{}, len(T):{}".format(len(Y_healthy),
         len(U_healthy), len(T_healthy)))
    print("Shape Y[0]:{}, Shape U[0]:{}, Shape T[0]:{}".format(
         Y_healthy[0].shape, U_healthy[0].shape, T_healthy[0].shape))
    ...
    print("Generated data that can be used in the cLV code")
